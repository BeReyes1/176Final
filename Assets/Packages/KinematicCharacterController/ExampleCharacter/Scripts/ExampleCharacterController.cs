...
namespace KinematicCharacterController.Examples
{
    ...
    public class ExampleCharacterController : MonoBehaviour, ICharacterController
    {
        ...
        {
            // Clamp input
            Vector3 moveInputVector = Vector3.ClampMagnitude(new Vector3(moveDirection.x, 0f, moveDirection.y), 1f);
                ...
                case CharacterState.Default:
                    {
                        ...
                        float targetVelocity = MaxStableMoveSpeed;
                        ...
                        {
                            targetVelocity = MaxStableMoveSpeed;
                        }
